...
namespace U3
{
  ...
  { 
    ...
    ///<summary>Sets image for each element in selection.</summary>
    ///<param name="dataFunc">A function that is called for each element. It is given the element, the bound datum, and expected to return the texture.</param>
